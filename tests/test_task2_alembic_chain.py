...
class Task2AlembicChainTests(unittest.TestCase):
    def test_tracked_migrations_form_a_single_history_to_coupon_scope_head(self):
        """未跟踪的本地实验迁移不能改变本提交发布的升级图。"""
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertEqual(scripts.get_heads(), ["20260826_coupon_template_store_scope"])
            self.assertIn(
