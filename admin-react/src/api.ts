...
export const getProjectRecordOptions = (schemaVersion: 6 | 7 = 7) => client.get('/technician/service-record-options', { params: { schema_version: schemaVersion } });
...
export const createCustomerProfileRecord = (data: {
  ...
  taxonomy_version?: 'service_reference_v1' | 'service_reference_v2' | 'service_reference_v3' | 'service_reference_v4' | 'service_record_v1' | 'service_handoff_v1';
